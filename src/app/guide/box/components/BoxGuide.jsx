        ...
        <div className='content'>
            ...
            <div>
                ...
                <Accordion>
                    ...
                    <AccordionDetails>
                        <p>
                            Регистрация происходит через нашего менеджера.
                        </p>
                        <p>
                            Менеджер регистрирует вас в системе и выдаёт 2 уникальных QR-кода:
                        </p>
                        <p className='NestedP'>
                            1) QR-код для вохода в аккаунт: этот qr-код дает вам доступ к вашему личному кабинету.
                        </p>
                        <p className='NestedP'>
                            2) QR-код для продаж: отсканировав этот qr-код, клиенты могут отслеживать ваш каталог товаров и осуществлять заказы.
                        </p>
                        <p>
                            Регистрация контейнеров проходит в индивидуальном порядке и за нее может взыматься плата.
                        </p>
                        <p>
                            Если вы утратили qr-код, обратитесь к нам по номеру <Link href="tel:+996556010516"> +996 556 010 516 </Link>. Выпуск новых qr-кодов - бесплатен.
                        </p>
                    </AccordionDetails>
                </Accordion>
                ...
                <Accordion>
                    ...
                    <AccordionDetails>
                        ...
                        <p className='NestedP'>
                            - перейдите в <Link href="/box-account"> личный кабинет</Link>
                        </p>
                        <p className='NestedP'>
