...
import GoToCartModal from '@/app/components/ux-kit/GoToCartModal/GoToCartModal';
...
import BuyNowModal from '@/app/components/ux-kit/BuyNowModal/BuyNowModal';
...
function BoxSingleProduct(props) {
    ...
    const [box_description, setBoxDescription] = useState("")
    ...
    useEffect(() => {
        const fetchProduct = async () => {
            try {
                ...
                setBoxName(response.data.manufacter.factory_name)
                setBoxDescription(response.data.manufacter.factory_description)
                setSupplierId(response.data.manufacter.supplier_id)
            } catch (error) {
    ...
    return (
        <div className='product_details'>
            ...
            <div className='BoxInfo'>
                <Link href={`/box/${supplier_id}`} className='topInfo'>
