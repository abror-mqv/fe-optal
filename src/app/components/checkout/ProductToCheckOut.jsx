...
import { Accordion, AccordionDetails, AccordionSummary, Divider, IconButton, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Tooltip } from '@mui/material';
import Paper from '@mui/material/Paper';
import { styled } from '@mui/material/styles';
import { tableCellClasses } from '@mui/material/TableCell';
import CurrencyFormatter from '../CurrencyFormatter/CurrencyFormatter';
function ProductToCheckOut({ key, el }) {
        ...
        <div className='oneGood'>
            <Accordion>
                <AccordionSummary
                    ...
                    id="panel1-header"
                >
                    <h4 className='summary'>{el.name}</h4>
                </AccordionSummary>
                <AccordionDetails>
